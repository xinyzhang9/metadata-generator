...
def make(parent, prefix, params):
    ...
    firstEndpointEntityName = SubElement(
        relationDescriptor, QName(prefix, "firstEndpointEntityName"))
    ...
    secondEndpointEntityName = SubElement(
        relationDescriptor, QName(prefix, "secondEndpointEntityName"))
