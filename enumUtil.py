...
def make(parent, prefix, params):
    ...
    if "values" in params.keys():
        for t in params["values"]:
            ...
            localizedLabelKey = SubElement(
                value, QName(prefix, "localizedLabelKey"))
